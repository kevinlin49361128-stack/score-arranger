...
PIECES = [
    ...
    # ─── 0.1.45 加碼 — 大型套曲完整化 ─────────────────────────────
    # Schubert Schwanengesang D.957 (8 首代表, 含 Ständchen / Der Doppelgänger)
    ("Schubert,_Franz", "Schwanengesang,_D.957", "1_Liebesbotschaft",
     "", "schubert_d957_01_liebesbotschaft", "Romantic"),
    ("Schubert,_Franz", "Schwanengesang,_D.957", "4_Ständchen",
     "", "schubert_d957_04_staendchen", "Romantic"),
    ("Schubert,_Franz", "Schwanengesang,_D.957", "5_Aufenthalt",
     "", "schubert_d957_05_aufenthalt", "Romantic"),
    ("Schubert,_Franz", "Schwanengesang,_D.957", "7_Abschied",
     "", "schubert_d957_07_abschied", "Romantic"),
    ("Schubert,_Franz", "Schwanengesang,_D.957", "9_Ihr_Bild",
     "", "schubert_d957_09_ihrbild", "Romantic"),
    ("Schubert,_Franz", "Schwanengesang,_D.957", "11_Die_Stadt",
     "", "schubert_d957_11_diestadt", "Romantic"),
    ("Schubert,_Franz", "Schwanengesang,_D.957", "13_Der_Doppelgänger",
     "", "schubert_d957_13_doppelganger", "Romantic"),
    ("Schubert,_Franz", "Schwanengesang,_D.957", "14_Die_Taubenpost",
     "", "schubert_d957_14_taubenpost", "Romantic"),
    # Schubert Winterreise D.911 (6 首代表)
    ("Schubert,_Franz", "Winterreise,_D.911", "1_Gute_Nacht",
     "", "schubert_d911_01_gutenacht", "Romantic"),
    ("Schubert,_Franz", "Winterreise,_D.911", "5_Der_Lindenbaum",
     "", "schubert_d911_05_lindenbaum", "Romantic"),
    ("Schubert,_Franz", "Winterreise,_D.911", "11_Frühlingstraum",
     "", "schubert_d911_11_fruhlingstraum", "Romantic"),
    ("Schubert,_Franz", "Winterreise,_D.911", "13_Die_Post",
     "", "schubert_d911_13_diepost", "Romantic"),
    ("Schubert,_Franz", "Winterreise,_D.911", "15_Die_Kraehe",
     "", "schubert_d911_15_diekraehe", "Romantic"),
    ("Schubert,_Franz", "Winterreise,_D.911", "24_Der_Leiermann_(Spätere_Fassung)",
     "", "schubert_d911_24_leiermann", "Romantic"),
    # Schumann Frauenliebe und Leben Op.42 (補完 No.3-8)
    ("Schumann,_Robert", "Frauenliebe_und_Leben,_Op.42",
     "3_Ich_kann’s_nicht_fassen", "", "schumann_op42_3_fassen", "Romantic"),
    ("Schumann,_Robert", "Frauenliebe_und_Leben,_Op.42",
     "4_Du_Ring_an_meinem_Finger", "", "schumann_op42_4_ring", "Romantic"),
    ("Schumann,_Robert", "Frauenliebe_und_Leben,_Op.42",
     "5_Helft_mir,_ihr_Schwestern",
     "", "schumann_op42_5_helft", "Romantic"),
    ("Schumann,_Robert", "Frauenliebe_und_Leben,_Op.42",
     "6_Süsser_Freund,_du_blickest",
     "", "schumann_op42_6_suesser", "Romantic"),
    ("Schumann,_Robert", "Frauenliebe_und_Leben,_Op.42",
     "7_An_meinem_Herzen",
     "", "schumann_op42_7_herzen", "Romantic"),
    ("Schumann,_Robert", "Frauenliebe_und_Leben,_Op.42",
     "8_Nun_hast_du_mir_den_ersten_Schmerz_getan",
     "", "schumann_op42_8_schmerz", "Romantic"),
    # Berlioz Les nuits d'été 補 2 首
    ("Berlioz,_Hector", "Les_nuits_d’été,_Op.7", "2_Le_spectre_de_la_rose",
     "", "berlioz_nuits_2_spectre", "Romantic"),
    ("Berlioz,_Hector", "Les_nuits_d’été,_Op.7", "4_Absence",
     "", "berlioz_nuits_4_absence", "Romantic"),
    # Mahler Des Knaben Wunderhorn (1 首)
    ("Mahler,_Gustav", "Des_Knaben_Wunderhorn", "7_Rheinlegendchen",
     "", "mahler_wunderhorn_7_rhein", "Romantic"),
    # Wolf Eichendorff-Lieder (3 首代表)
    ("Wolf,_Hugo", "Eichendorff-Lieder", "3_Verschwiegene_Liebe",
     "", "wolf_eichendorff_3_verschwiegene", "Romantic"),
    ("Wolf,_Hugo", "Eichendorff-Lieder", "12_Heimweh",
     "", "wolf_eichendorff_12_heimweh", "Romantic"),
    ("Wolf,_Hugo", "Eichendorff-Lieder", "18_Erwartung",
     "", "wolf_eichendorff_18_erwartung", "Romantic"),
]
